...
const steps = [
  {
    ...
    text: "Complete our simple registration process to join thousands of successful restaurants on Foodsyaa. Get verified and start building your online presence immediately.",
