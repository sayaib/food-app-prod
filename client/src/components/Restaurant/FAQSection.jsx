...
const faqs = [
  {
    ...
    answer: "To register your restaurant with FoodYah, you'll need to provide your PAN card, GST registration, FSSAI license, high-quality menu images, bank account details for payments, and proof of restaurant ownership or authorization to operate.",
    category: "Registration"
  },
  {
    question: "Is there any cost to onboard my restaurant?",
    answer: "Restaurant registration and onboarding with FoodYah is completely free. We operate on a commission-based model where we charge a small percentage on each successful order. There are no monthly fees or hidden charges.",
    category: "Pricing"
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, FoodYah offers a complete delivery solution. Our network of delivery partners will pick up orders from your restaurant and deliver them to customers. You can also use your own delivery staff if preferred, giving you flexibility based on your business needs.",
    category: "Delivery"
  },
  {
    question: "What kind of support does FoodYah provide to restaurant partners?",
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Everything you need to know about partnering with FoodYah
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 shadow-sm">
          ...
          <a 
            href="mailto:partners@foodyah.com" 
